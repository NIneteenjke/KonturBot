...
#Блок еще
    ...
    if message.text == 'Кто может учавствовать':
    ...
    if message.text == 'Дополнительные вознаграждения':
    ...
    if message.text == 'Инструменты и продвежение':
    ...
    if message.text == 'Банеры для сайта':
    ...
    if message.text == 'Банеры для соцсетей':
...
#Блок рекомендаций продукта
    ...
    if message.text == 'Выберите продукт':
        await bot.send_message(message.from_user.id,'[Выберите продукт](https://support.kontur.ru/pages/viewpage.action?pageId=18350835)',parse_mode='Markdown', reply_markup=recommendationsKeyboard)
        logger.debug('Пользователь нажал кнопку "Выберите продукт"')

    if message.text == 'Выберите аудиторию':
        await bot.send_message(message.from_user.id,
                               '[Выберите аудиторию](https://support.kontur.ru/pages/viewpage.action?pageId=83870810)',parse_mode='Markdown',reply_markup=recommendationsKeyboard)
        logger.debug('Пользователь нажал кнопку "Какие продукты рекомендовать"')
